...
setup_application:
	...
	(cd ${APP_DIR} && ${COMPOSER} config --no-plugins allow-plugins.symfony/thanks true)
	(cd ${APP_DIR} && ${COMPOSER} config --no-plugins allow-plugins.symfony/flex true)
	(cd ${APP_DIR} && ${COMPOSER} config --no-plugins allow-plugins.dealerdirect/phpcodesniffer-composer-installer true)
	(cd ${APP_DIR} && ${COMPOSER} config --no-plugins allow-plugins.phpstan/extension-installer true)
